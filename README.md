...
- **Fast Trigonometric transforms**  
 Implementations of various fast randomized trigonometric transforms are available at `code/sketches/SparseTrigTransforms/srtt_explicit.c`. The current implementation **explicitly** forms the matrix
