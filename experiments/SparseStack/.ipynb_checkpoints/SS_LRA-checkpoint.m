% ZETA_TESTSS_FULL   Compare Gaussian vs. sparse-sign-i-subcols vs. iid-column
% on nine test matrices, RSVD error measurement
...
%% Main loops: for each profile p, ζ, k, run trials
    ...
    for zi = 1:numZeta
        ...
        for ki = 1:numKs
            ...
            for run = 1:num_runs
                ...
                OmegaS    = sparse_sign_isubcols(k, n, zeta)';
                YS        = A_full * OmegaS;
                QS        = orth(YS);
